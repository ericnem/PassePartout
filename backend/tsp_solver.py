...
class TSPSolver:
    ...
    def solve_tsp(self, distance_matrix: List[List[float]], max_distance: float) -> List[int]:
        """
    ...
    def get_route_distance(self, route: List[int], distance_matrix: List[List[float]]) -> float:
        """
